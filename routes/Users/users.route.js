...
import { createContactus, getContactus, sendContactQuery, updateContactUs } from "../../controllers/ContactUs.js";
...
import { DeleteFaq, GetFilteredFaqs, SetFaqs, UpdateFaq } from "../../controllers/Faq.js";
...
import { createGalleryContent, getGalleryImagesByQuery, UpdateGallary } from "../../controllers/Gallery.js";
...
import { DeleteProperty, GetAllProperties, GetPropertyObj, SetProperty, UpdateProperty } from "../../controllers/Properties.js";
...
router.post('users/change-pass', Auth, ChangePassword);
